	...
	public class RPGCharacterInputController : MonoBehaviour
    {
        ...
        private void Inputs()
        {
            try {
                ...
                inputFace = true;//Input.GetMouseButton(1);
        ...
        private void Attacking()
        {
			...
			else if (inputAttackR) { Debug.Log("PRESSED RIGHT"); rpgCharacterController.StartAction("Attack", new Actions.AttackContext("Attack", "Right")); }
